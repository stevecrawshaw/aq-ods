...
ca_boundaries <- st_read("https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/Combined_Authorities_May_2023_Boundaries_EN_BGC/FeatureServer/0/query?outFields=*&where=1%3D1&f=geojson")
...
aurn_ca_tbl <- importAURN(site = aurn_codes_in_ca, verbose = TRUE, year = 2019:2024)
